...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	glview->setDesignResolutionSize(1600, 900, ResolutionPolicy::FIXED_WIDTH);
	for (int i = 0; i < 8; i++) {
		director->getTextureCache()->addImage(StringUtils::format("res/tetris_%d.png", i));
	}
